...
class Interceptor extends \Magento\Bundle\Model\LinkManagement implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function addChildren(\Magento\Catalog\Api\Data\ProductInterface $product, int $optionId, array $linkedProducts): void
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addChildren');
        $pluginInfo ? $this->___callPlugins('addChildren', func_get_args(), $pluginInfo) : parent::addChildren($product, $optionId, $linkedProducts);
    }
