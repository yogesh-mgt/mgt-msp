...
class Interceptor extends \Magento\EavGraphQl\Model\Resolver\CustomAttributeMetadata implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\EavGraphQl\Model\Resolver\Query\Type $type, \Magento\EavGraphQl\Model\Resolver\Query\Attribute $attribute)
    {
        $this->___init();
        parent::__construct($type, $attribute);
    }
