...
class Interceptor extends \Magento\User\Controller\Adminhtml\Auth\ResetPasswordPost implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\User\Model\UserFactory $userFactory, ?\Magento\Backend\Helper\Data $backendDataHelper = null, ?\Magento\User\Helper\ForceSignIn $forceSignIn = null)
    {
        $this->___init();
        parent::__construct($context, $userFactory, $backendDataHelper, $forceSignIn);
    }
